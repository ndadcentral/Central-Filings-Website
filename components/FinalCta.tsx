        ...
        <div className={`glass-surface ${styles.ctaBanner}`}>
          <div className={styles.ctaContent}>
            ...
            <p className={styles.ctaText}>
              Whether you need to treat an active cavity, replace an aged amalgam filling, or relieve toothache pain, our clinical team is ready to restore your smile in a single visit.
            </p>
